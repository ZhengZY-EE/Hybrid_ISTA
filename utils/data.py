...
def dir2tfrecords_cs (data_dir, out_path, Phi, patch_size, patches_per_image, suffix):
    ...
    # img_fs = np.array(img_total)
    # print(img_fs.shape)
    # np.save('image.npy', img_fs)
...
parser.add_argument(
    "--sensing", type=str, default='./data/0_04_mm.npy', help="Sensing matrix file. Instance of Problem class.")
parser.add_argument(
    "--patch_size", type=int, default=16, help="Size of extracted patches.")
parser.add_argument(
    "--patches_per_img", type=int, default=10, help="How many patches to be extracted from each image.")
