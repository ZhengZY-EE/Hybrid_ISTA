...
class Hybrid_ISTA_ada_fixT_cs (LISTA_base):

    def __init__ (self, Phi, D, T, lam, untied, coord, scope, mode='S', conv_num=3, kernel_size=9, feature_map=16, alpha_initial=0.0):
