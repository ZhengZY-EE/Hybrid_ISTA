...
class Hybrid_GLISTA (LISTA_base):
    ...
    def setup_layers(self):
        ...
        # vars_in_layer [t]
        self.vars_in_layer = list (zip (log_epsilon_, Ws1_, thetas1_, Ws2_, thetas2_, B_g1_, W_g1_, B_g2_, W_g2_, alti_over1, alti_over2, roi, learn_vec, self.paras_, self.alphas_raw))
    ...
    def inference(self, y_, x0_=None):
        ...
        with tf.variable_scope (self._scope, reuse=True) as vs:
            ...
            for t in range (self._T):
                log_epsilon, W1_, theta1_, W2_, theta2_, B_g1, W_g1, B_g2, W_g2, alti_over1, alti_over2, roi, learn_vec, dnn_para_, alpha_raw = self.vars_in_layer[t]
