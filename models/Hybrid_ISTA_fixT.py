...
class Hybrid_ISTA_fixT (LISTA_base):
    ...
    def setup_layers(self):
        ...
        # vars_in_layer [t]
        self.vars_in_layer = list (zip (delta_total_, ts_scalar_, self.paras_, self.alphas_raw))
    ...
    def inference (self, y_, x0_=None):
        ...
        with tf.variable_scope (self._scope, reuse=True) as vs:
            for t in range (self._T):
                ...
                del_, t_, dnn_para_, alpha_raw = self.vars_in_layer [t]
                ...
                self.vh_list.append(vh_)
                self.wh_list.append(wh_)
