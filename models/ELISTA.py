...
LastEditTime: 2022-01-19 11:19:58
'''
import numpy as np
...
class ELISTA (LISTA_base):

    """
    Implementation of ELISTA.
    """
    def __init__ (self, A, T, lam, untied, coord, scope, mt_flag):
        """
    ...
    def setup_layers(self):
        ...
        with tf.variable_scope (self._scope, reuse=False) as vs:
            ...
            if not self._mt_flag:
                ...
                self.vars_in_layer = list (zip (Ws1_, Ws2_, alphas1_, alphas2_, thetas1_, thetas2_)) 
                ...
                self.vars_in_layer = list (zip (Ws1_, Ws2_, alphas1_, alphas2_, thetas1_, thetas2_, thetas1_bar_, thetas2_bar_)) 
